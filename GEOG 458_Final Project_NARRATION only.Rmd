...
These variables for each tract include: Ethnicity, Educational Attainment, Median Household Value, and Housing Status (Renters vs. Buyers).

<!-- , and proximity to Link Light Rail. ![Map of Link Light Rail](literail.png)
