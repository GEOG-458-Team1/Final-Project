...
```{r data load include=FALSE, message=FALSE, warning=FALSE, echo=FALSE}
...
```
```{r generate z scores message=FALSE, warning=FALSE, echo=FALSE}
...
```{r generate z scores 2 echo=FALSE,  message=FALSE, warning=FALSE}
#get percentage for each variable and create z scores for each percentage
#get percent white population count
...
```{r shapefiles and index creation echo=FALSE,  message=FALSE, warning=FALSE}
...
```{r merge data to shapefiles include=FALSE, echo=FALSE,  message=FALSE, warning=FALSE}
#foor 2009
#loading in king county census tract
...
```{r 2009 map echo=FALSE,  message=FALSE, warning=FALSE}
#get range for data
...
```{r 2009 map 2 echo=FALSE,  message=FALSE, warning=FALSE}
#leaflet map
